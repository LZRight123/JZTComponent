...
public extension UIColor
{
    ...
    static let hexA18D86 = UIColor(hex: "A18D86")
    static let hexEFE0D7 = UIColor(hex: "EFE0D7")
    static let hexFFFFFF = UIColor(hex: "FFFFFF")
    static let test = #colorLiteral(red: 0.9647058824, green: 0.2980392157, blue: 0.07450980392, alpha: 1)
    static let hexFBF8D9 = UIColor(hex: "FBF8D9")
    static let hexED8A00 = #colorLiteral(red: 0.9294117647, green: 0.5411764706, blue: 0, alpha: 1)
    //MARK:- 3.7.0
    static let hexc8a06a = UIColor(hex: "c8a06a")
    static let hexfbf5ec = UIColor(hex: "fbf5ec")
    static let hexf4eadc = UIColor(hex: "f4eadc")
    static let hex92682e = UIColor(hex: "92682e")
    static let hexFCFCFC = UIColor(hex: "FCFCFC")
    static let hexfff6f1 = UIColor(hex: "fff6f1")
    //MARK:- 3.8.0
    static let hexF9F9F9 = UIColor(hex: "f9f9f9")
    //MARK:- 3.9.0
    static let hexFF9F2D = UIColor(hex: "FF9F2D")
    static let hexFF6A19 = UIColor(hex: "FF6A19")
    static let hexffe7da = UIColor(hex: "ffe7da")
    static let hexff7022 = UIColor(hex: "ff7022")
    static let hex2c2930 = UIColor(hex: "2c2930")
    static let hexff0e47 = UIColor(hex: "ff0e47")
    static let hexfff08e = UIColor(hex: "fff08e")
    static let hex333333 = UIColor(hex: "333333")
